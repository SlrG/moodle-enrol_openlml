...
$string['openlmlsync'] = 'Open LML-Einschreibung synchronisieren';
$string['pluginname'] = 'Open LML-Einschreibung';
$string['pluginname_desc'] = '<p>Sie können einen OpenLML-Server nutzen, um die Anmeldung von Teilnehmer/innen in Kursen zu verwalten.</p><p>Es wird angenommen, dass der Open LML-LDAP-Baum Gruppen enthält, die zu Kursen gehören und dass jede/r der Gruppen/Kurse Einträge von Teilnehmer/innen hat. Es wird weiterhin angenommen, dass die Lehrer (Trainer in der Moodle-Sprechweise) in der Gruppe teachers im LDAP-Baum definiert sind und in den Mitgliedsfeldern dieser Gruppe eingetragen sind.(<em>member</em> oder <em>memberUid</em>), die eine eindeutige Identifizierung des/der Nutzer/in ermöglichen.</p><p>Um das OpenLML-LDAP als Kurs-Anmeldeverfahren zu verwenden, <strong>muss</strong> jeder Nutzer eine gültige ID-Nummer(uid) besitzen. Die LDAP-Gruppen müssen diese ID-Nummer in den Mitgliedsfeldern aufweisen, um den/die Nutzer/in als Teilnehmer/in in den Kurs einzuschreiben. Dies funktioniert normalerweise sehr gut, wenn Sie LDAP auch zur Nutzerauthentifizierung nutzen.</p><p>Für die Kursanmeldungen wird die Kurs-ID verwendet. Da sie eindeutig sein muss, wird "Kurzname:" vorangestellt.</p><p>Kursanmeldungen werden aktualisiert, wenn der Nutzer sich in Moodle einloggt. Sie können auch ein Skript nutzen, um Kursanmeldungen zu synchronisieren. Moodle liefert ein solches Skript: <em>enrol/openlml/cli/sync.php</em>. Sie können das OSS-Anmeldeverfahren auch so konfigurieren, dass automatisch neue Kurse angelegt werden, wenn neue Gruppen in LDAP eingerichtet werden.</p>';
...
$string['student_project_prefix'] = 'Der Gruppenbezeichnung in der Open LML wird normalerweise ein P_ vorangestellt.';
...
$string['sync_description'] = 'Synchronisiert mit Open LML-Server';
...
$string['teachers_context_settings_desc'] = 'Einstellungen, welche die Kategorie beeinflussen, wo Lehrerkategorien erstellt werden';
...
$string['teacher_settings_desc'] = 'Spezielle Gruppen mit Lehrern als Mitgliedern werden von dieser Einstellung beeinflusst';
